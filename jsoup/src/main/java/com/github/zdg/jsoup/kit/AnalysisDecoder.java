...
import com.github.zdg.jsoup.data.ClassReader;
import com.github.zdg.jsoup.data.Resource;
import com.github.zdg.jsoup.decoder.Decoder;
import com.github.zdg.jsoup.decoder.ReflectionDecoderFactory;
...
public class AnalysisDecoder {
    ...
    final static Map<Class, Decoder> NATIVE_DECODERS = new HashMap<Class, Decoder>() {{
        put(float.class, new Decoder.FloatDecoder() {
            @Override
            public float decodeFloat(JsoupReaderContext context) {
        ...
        put(double.class, new Decoder.DoubleDecoder() {
            @Override
            public double decodeDouble(JsoupReaderContext context) {
        ...
        put(boolean.class, new Decoder.BooleanDecoder() {
            @Override
            public boolean decodeBoolean(JsoupReaderContext context) {
        ...
        put(byte.class, new Decoder.ShortDecoder() {
            @Override
            public short decodeShort(JsoupReaderContext context) {
        ...
        put(int.class, new Decoder.IntDecoder() {
            @Override
            public int decodeInt(JsoupReaderContext context) {
        ...
        put(long.class, new Decoder.LongDecoder() {
            @Override
            public long decodeLong(JsoupReaderContext context) {
