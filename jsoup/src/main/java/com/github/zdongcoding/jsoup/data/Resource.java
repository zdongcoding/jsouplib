...
public class Resource {
    ...
    public Object deserialize(JsoupReaderContext context){
        if (context==null)  throw new JsoupReaderException(" not decoder");
        if (decoder != null) {
            try {
    ...
    public Object deserialize(Elements elements){
      return   deserialize(new JsoupReaderContext(elements, this));
    }
